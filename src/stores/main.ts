export const useMainStore = defineStore({
  ...
  state: () => ({
    ...
    locatorService: {
      ...
      txt: "Our company can help you locate qualified tenants for your property. Rental prospects go under our application process and sign a Texas Residential Lease prepared by us at our office or online. After move in is complete, management will be transferred to you.",
    },
    moveOutService: {
      title: "move out services",
      txt: "Evictions and move outs can be hard to handle if you do not count with a property manager. We can help you with an eviction process or conduct a final walk thru with your tenants.",
    },
    propertyManagementService: {
      ...
      txt: "Our realtors come with extensive property management backgrounds making the process of hiring a property manager easier. Our services require no upfront fees, we can start advertising in less than 24 hours.",
    },
    services: [
      {
        name: "locatorService",
